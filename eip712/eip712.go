...
// Modified for Cobo compatibility: ChainId is string (decimal) instead of *math.HexOrDecimal256
...
func (domain *TypedDataDomain) validate() error {
	if len(domain.ChainId) == 0 && len(domain.Name) == 0 && len(domain.Version) == 0 && len(domain.VerifyingContract) == 0 && len(domain.Salt) == 0 {
